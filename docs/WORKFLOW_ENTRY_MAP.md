...
- Need to place parser-adjacent work honestly: read `docs/PARSER_READINESS_MAP.md` for the boundary map, then use `prompts/codex/parser-lane-chooser.md` when you want a concise lane recommendation without changing shell behavior.
