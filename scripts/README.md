...
- `brief`: print the local picker summary from checked-in prompt packs and super-agent files, with a quick-scan family view, clearer first-pick cues, and explicit notices when fallback, missing, or empty metadata is encountered
